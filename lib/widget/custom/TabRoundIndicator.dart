...
class TabRoundIndicator extends Decoration {
  /// topRight radius of the indicator, default to 0.
  final double topRightRadius;

  /// topLeft radius of the indicator, default to 0.
  ...
  /// total radius of the indicator, default to 0
  final double radius;
  ...
  @override
  _TabRoundIndicatorPainter createBoxPainter([VoidCallback? onChanged]) {
    return new _TabRoundIndicatorPainter(
      this,
      onChanged,
      bottomLeftRadius: radius == 0 ? bottomLeftRadius : radius,
      bottomRightRadius: radius == 0 ? bottomRightRadius : radius,
      color: color,
      horizontalPadding: horizontalPadding,
      topLeftRadius: radius == 0 ? topLeftRadius : radius,
      topRightRadius: radius == 0 ? topRightRadius : radius,
...
class _TabRoundIndicatorPainter extends BoxPainter {
  final TabRoundIndicator decoration;
  final double topRightRadius;
  final double topLeftRadius;
  final double bottomRightRadius;
  final double bottomLeftRadius;
  ...
  void paint(Canvas canvas, Offset offset, ImageConfiguration configuration) {
    ...
    Size mysize = Size(configuration.size!.width - (horizontalPadding * 2), configuration.size!.height - (2 * verticalPadding));
