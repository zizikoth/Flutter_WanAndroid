...
class TabDotIndicator extends Decoration {
  ...
  @override
  _TabDotIndicatorPainter createBoxPainter([VoidCallback? onChanged]) {
    return new _TabDotIndicatorPainter(
      this,
      onChanged,
      radius,
      color,
...
class _TabDotIndicatorPainter extends BoxPainter {
  final TabDotIndicator decoration;
  final double radius;
  final Color color;
  final double distanceFromCenter;
  final PaintingStyle paintingStyle;
